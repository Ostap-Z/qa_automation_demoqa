...
class FormLocators:
    ...
    GENDER = (By.CSS_SELECTOR, f"div.custom-control.custom-radio.custom-control-inline label[for='gender-radio-{randint(1, 3)}']")
    MOBILE = (By.CSS_SELECTOR, "input#userNumber")
    BIRTH_DATE = (By.CSS_SELECTOR, "input#dateOfBirthInput")
    SUBJECT = (By.CSS_SELECTOR, "input#subjectsInput")
    HOBBIES = (By.CSS_SELECTOR, f"div.custom-control.custom-checkbox.custom-control-inline label[for='hobbies-checkbox-{randint(1, 3)}']")
