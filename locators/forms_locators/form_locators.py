...
class FormLocators:
    ...
    GENDER = (By.CSS_SELECTOR, f"div.custom-control.custom-radio.custom-control-inline input[id='gender-radio-{randint(1, 3)}']")
    ...
    HOBBIES = (By.CSS_SELECTOR, f"div.custom-control.custom-checkbox.custom-control-inline input[id='hobbies-checkbox-{randint(1, 3)}']")
