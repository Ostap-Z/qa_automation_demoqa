...
class TestSortable:
    ...
    def test_sortable(self, driver):
        ...
        sortable_page.open()
        list_order_before, list_order_after = sortable_page.change_item_order("list")
        grid_order_before, grid_order_after = sortable_page.change_item_order("grid")
        assert list_order_before != list_order_after, \
            ...
            f"\nExpected result:\n\tSortable items order before and after should be different. So, items order was changed"
