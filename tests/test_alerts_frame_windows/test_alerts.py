...
class TestAlerts:
    ...
    def test_prompt_alert(self, driver):
        ...
        assert text == prompt_text_result, f"Actual result: text presented in the span is '{prompt_text_result}'"\
                                           f"Expected result: result text in the span should be '{text}'"
