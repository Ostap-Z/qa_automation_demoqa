...
class TextBoxPage(BasePage):
    ...
    def fill_in_form_fields(self):
        ...
        self.element_is_visible(self.locators.PERNAMENT_ADDRESS).send_keys(permanent_address)
    ...
    def validate_filled_form(self):
        ...
        permanent_address = self.element_is_present(self.locators.CREATED_PERNAMENT_ADDRESS).text
        return full_name, email, current_address, permanent_address
