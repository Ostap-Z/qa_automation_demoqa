...
class ToolTipsPage(BasePage):
    ...
    def check_tool_tips(self, tool_tip_type):
        log = self.get_logger()

        with allure.step("Check the 'Hover Me Tool Tip' button"):
            if tool_tip_type == "button":
        ...
        with allure.step("Check the 'Hover Me Tool Tip' input"):
            if tool_tip_type == "input":
                ...
                return tool_tip_text_input

        with allure.step("Check the 'Contrary Tool Tip' link"):
            if tool_tip_type == "contrary":
                ...
                return tool_tip_text_contrary

        with allure.step("Check the 'Section Tool Tip' link"):
            if tool_tip_type == "section":
